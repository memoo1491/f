...
EOD;
 ...
 <table border="0" cellpadding="0" cellspacing="0">
  <tr class="titlebg">
    <td colspan="3" class="titletext">新春迎好運<br>
      純金999『金好神』乙尊  共3名</td></tr>
  <tr>
  <td align="left">王*榕</td>
  <td align="left">vivi***868@yahoo.com.tw</td>
  </tr>
  <tr>
  <td align="left">陽*川</td>
  <td align="left">nguy***68962@yahoo.com.tw</td>
  </tr>
  <tr>
  <td align="left">許*豪</td>
  <td align="left">annh***ong@gmail.com</td>
  </tr>
 </table>
...
EOD;
    ...
    case '20150316': //醜比頭
        $PREV_LINE_ACTION_START_DATE = '2015-02-17 00:00:00'; 
        $PREV_LINE_ACTION_END_DATE = '2015-03-03 23:59:59';
        $PREV_LINE_ACTION_LOTTERY_DATE = "2015-03-10 00:00:00";

        $LINE_ACTION_START_DATE = '2015-03-17 00:00:00'; 
        $LINE_ACTION_END_DATE = '2015-04-09 23:59:59';
        $LINE_ACTION_LOTTERY_DATE = "2015-04-14 00:00:00";
        ...
        ////------------------ WINNER
        $vars['web']['btn_winner_submit'] = $vars['web']['images_path_winner']."download.png";  
        $vars['web']['link_to_winner'] = "http://www.family.com.tw/marketing/PublicDetail.aspx?ID=1056";  
        $vars['download']['filename'] = "中獎通知書-{$vars['web']['title']}.doc";  
        $vars['download']['myFile'] = "winner_letter/winner_letter_{$vars['unit']}.doc";  
 ...
 <table border="0" cellpadding="0" cellspacing="0">
  <tr class="titlebg">
   <td colspan="2" class="titletext">醜比頭在我家<br>
      杯緣湯匙馬克杯一套 共5名</td></tr>
  <tr>
  <td align="left">楊*如</td>
  <td align="left">gip650***@yahoo.com.tw</td>
  </tr>
  <tr>
  <td align="left">黃*怡</td>
  <td align="left">shor***@yahoo.com.tw</td>
  </tr>
  <tr>
  <td align="left">呂*怡</td>
  <td align="left">a520r***@gmail.com</td>
  </tr>
  <tr>
  <td align="left">王*琴</td>
  <td align="left">pig455***@yahoo.com.tw</td>
  </tr>
  <tr>
  <td align="left">ch*ao</td>
  <td align="left">bao.k***@gmail.com</td>
  </tr>
 </table>
...
EOD;
    ...
    case '20150416': //春遊好時光
        $PREV_LINE_ACTION_START_DATE = '2015-03-17 00:00:00'; 
        $PREV_LINE_ACTION_END_DATE = '2015-04-09 23:59:59';
        $PREV_LINE_ACTION_LOTTERY_DATE = "2015-04-14 00:00:00";

        $LINE_ACTION_START_DATE = '2015-04-17 00:00:00'; 
        $LINE_ACTION_END_DATE = '2015-05-05 23:59:59';
        $LINE_ACTION_LOTTERY_DATE = "2015-05-12 00:00:00";

        $LINE_ACTION_LOTTERY_ENABLE = "1";
        $TEMPLATE_FORDER = "line_{$vars['unit']}";
        $ACTIVITY_TYPE = 'line';
        $ACTIVITY_ID = '20150416';  //自訂義
        $vars['unopen']['fill'] = '0';
        $vars['unopen']['action_end'] = '0';
        $vars['setting']['sign_up_enable'] = '1';
        //時間
